...
const NAV_ITEMS: NavItem[] = [
  { label: "DASHBOARD", path: "/", icon: <LayoutDashboard className="h-4 w-4" />, roles: ["ADMIN", "ESCOLAR", "ADMINISTRATIVO", "DOCENTE", "ALUMNO", "PADRE"], hasChevron: true },
    ...
    <div className="min-h-screen flex flex-col bg-transparent">
      ...
      <header className="sticky top-4 mx-4 md:mx-6 z-50 bg-gradient-to-r from-blue-700/95 via-blue-600/95 to-indigo-600/95 backdrop-blur-md shadow-lg rounded-2xl border-0">
        <div className="flex h-16 items-center gap-4 px-4 md:px-6">
          {/* Mockup Logo */}
          <div className="bg-white dark:bg-[#0F172A] px-4 py-2 rounded shadow-sm border border-neutral-100 dark:border-neutral-800 flex items-center font-heading text-sm font-bold tracking-tight select-none">
          ...
          <div className="flex items-center gap-2 shrink-0 text-white">
            ...
            <button
              ...
              className="flex items-center justify-center w-9 h-9 rounded-lg hover:bg-red-500/20 transition-all duration-200 text-white hover:text-red-200"
